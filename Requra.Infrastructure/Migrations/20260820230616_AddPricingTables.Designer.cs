...
namespace Requra.Infrastructure.Migrations
{
    ...
    [Migration("20260820230616_AddPricingTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Requra.Domain.Entities.IdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Requra.Domain.Entities.StripeWebhookEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Requra.Domain.Entities.UserSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Requra.Domain.Entities.UserSubscription", b =>
                {
                    b.HasOne("Requra.Domain.Entities.ApplicationUser", "User")
                        ...
                        .HasForeignKey("Requra.Domain.Entities.UserSubscription", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
